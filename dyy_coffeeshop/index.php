...
<body>
    <!-- Navbar start -->
     <nav class="navbar">
        <a href="#" class="navbar-logo">dyy<span>coffeeshop</span>.</a>
      ...
      <section class="hero" id="home">
        <main class="content">
            ...
            <p>Lorem ipsum dolor sit amet consectetur adipisicing 
                elit. Minima voluptate libero perferendis aperiam unde,
                 quam est? Distinctio, molestias amet. Ratione beatae ullam 
                 sit suscipit a atque quasi est placeat assumenda!</p>
